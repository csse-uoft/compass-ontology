...
class Client(cids.Person, cids.Stakeholder):
    ...
    is_a = [
        ...
        compass.hasEthnicity.only(compass.CL_Ethnicity),
        compass.membeOfAboriginalGroup.only(compass.CL_CA_AboriginalGroup),
        compass.hasReligion.only(compass.CL_Religion),
        ...
        compass.hasClientStatus.only(ClientStatus),
        compass.hasClientState.only(ClientState),
        ...
        compass.hasHomelessEvent.only(get_class('HomelessEvent')),
...
•	hasEthni`: A coded property specifying known ethnicities of the client.
...
•	hasEducationEvent: links to instances of EducationEvent, each defining education the person has received.
...
•	hasMedicalEvent: links to instances of MedicalEvent, each defining separate medical conditions.
...
•	hasBirthEvent: links to instances of BirthEvent
•	hasDeathEvent: links to instances of DeathEvent
•	hasMaritalEvent: links to instances of MaritalEvent
•	hasHomelessEvent: links to instances of HomelessEvent
